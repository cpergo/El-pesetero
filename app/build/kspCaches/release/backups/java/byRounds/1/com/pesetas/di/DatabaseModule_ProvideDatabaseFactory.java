...
public final class DatabaseModule_ProvideDatabaseFactory implements Factory<PesetasDatabase> {
  ...
  public static PesetasDatabase provideDatabase(Context context) {
