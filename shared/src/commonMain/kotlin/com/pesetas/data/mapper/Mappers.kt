...
fun TransactionEntity.toDomain() = Transaction(
    id = id,
    amount = amount,
    date = localDateFromEpochDay(dateEpochDay),
    type = type,
...
fun RecurringTransactionEntity.toDomain() = RecurringTransaction(
    ...
    lastGeneratedDate = localDateFromEpochDay(lastGeneratedEpochDay),
)
...
fun SavingsGoalEntity.toDomain() = SavingsGoal(
    ...
    deadline = deadlineEpochDay?.let { localDateFromEpochDay(it) },
    iconKey = iconKey,
    colorArgb = colorArgb,
)
